...
DJOSER = {
    'SERIALIZERS': {
        "user_create": "api_foodgram.users.serializers.UserCreateSerializer",
        "user": "api_foodgram.users.serializers.UserSerializer",
        "user_list": "api_foodgram.users.serializers.UserSerializer",
        "current_user": "api_foodgram.users.serializers.UserSerializer",
    },
    'PERMISSIONS': {
        "user_list": ["rest_framework.permissions.AllowAny"],
        "user_retrieve": ["rest_framework.permissions.AllowAny"],
    }
}
